package com.ichunzhen.ui.canvas;
 ...
 */
public class ZSplashView extends View {
    ...
    public ZSplashView(Context context) {
        super(context, null);
        init(context);
    }

    public ZSplashView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
