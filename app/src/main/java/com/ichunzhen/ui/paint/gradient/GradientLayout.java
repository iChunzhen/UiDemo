package com.ichunzhen.ui.paint.gradient;
...
//         * color1:渐变结束颜色
//         * colors:渐变数组  参数colors数组代表渐变过度颜色，
//         * positions:位置数组，position的取值范围[0,1],作用是指定某个位置的颜色值，如果传null，渐变就线性变化。
//         *              positions数组代表各过度色的起点位置（浮点类型）
//         * tile:用于指定控件区域大于指定的渐变区域时，空白区域的颜色填充方法  CLAMP、MIRROR、REPEAT
//         */
