...
import com.ichunzhen.materialdesign.adapter.EndlessRecyclerOnScrollListener;
import com.ichunzhen.materialdesign.adapter.LoadMoreAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                dlAtDrawLayout.openDrawer(GravityCompat.START);
                break;
            case R.id.add:
